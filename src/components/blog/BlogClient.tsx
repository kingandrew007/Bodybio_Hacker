...
export function BlogClient() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black text-foreground pt-24 pb-20 px-6 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 gsap-title relative">
          ...
          <h1 className="text-5xl md:text-8xl font-black font-mono tracking-tighter mb-6 text-white uppercase glitch-text" data-text="INTELLIGENCE_LOGS">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between mb-16 gsap-title">
          ...
          <div className="relative w-full md:w-96 group">
            ...
            <div className="relative bg-black/80 border border-white/10 rounded-xl overflow-hidden backdrop-blur flex items-center">
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-none py-4 px-4 text-sm font-mono text-white placeholder:text-neutral-600 focus:outline-none focus:ring-0 uppercase tracking-widest"
                />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.map((post, i) => (
            <Link key={post.slug} href={`/blog/${post.slug}`} className="group h-full gsap-blog-card block perspective-1000">
              <div className="relative h-full bg-black/40 border border-white/5 hover:border-hacker-green/50 hover:shadow-[0_0_40px_-5px_rgba(0,255,65,0.2)] transition-all duration-500 rounded-xl overflow-hidden group-hover:-translate-y-2 backdrop-blur-md flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col relative z-20">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold font-mono leading-tight mb-3 text-white group-hover:text-hacker-green transition-colors uppercase tracking-tight">
                    {post.title}
                  </h3>
                  ...
                  <div className="mt-auto">
                     <div className="flex items-center justify-between text-xs font-bold font-mono text-white group-hover:text-hacker-green transition-colors bg-white/5 p-3 rounded border border-white/5 group-hover:border-hacker-green/30">
          ...
          {filteredPosts.length === 0 && (
            <div className="col-span-full py-20 text-center gsap-blog-card border border-white/10 rounded-xl bg-black/40 backdrop-blur">
              <Database className="w-12 h-12 text-neutral-700 mx-auto mb-4 animate-pulse" />
              <div className="text-lg font-mono text-white">NO_DATA_FOUND_IN_SECTOR</div>
