      ...
      <section className="h-[90vh] flex items-center justify-center px-6 relative z-10">
        <div className="text-center max-w-5xl">
          <div className="overflow-hidden mb-2">
            <h1 className="hero-line text-4xl md:text-9xl font-bold leading-none tracking-tighter">
              WE ARE
            </h1>
          </div>
          <div className="overflow-hidden mb-6">
            <h1 className="hero-line text-4xl md:text-9xl font-bold leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-hacker-green to-blue-500 animate-gradient">
              THE GLITCH.
            </h1>
          </div>
        ...
        <div className="flex h-full w-[300vw]">
          ...
          <div className="horizontal-panel w-screen h-full flex items-center justify-center bg-card px-12 relative overflow-hidden">
            ...
            <div className="max-w-4xl relative z-10">
              ...
              <h2 className="text-3xl md:text-7xl font-bold mt-4 mb-8 text-foreground">The Industry is Toxic.</h2>
          ...
          <div className="horizontal-panel w-screen h-full flex items-center justify-center bg-background px-12 relative">
             ...
             <div className="max-w-4xl relative z-10">
              ...
              <h2 className="text-3xl md:text-7xl font-bold mt-4 mb-8 text-foreground">Data Over Marketing.</h2>
              <p className="text-2xl text-muted-foreground leading-relaxed">
          ...
          <div className="horizontal-panel w-screen h-full flex items-center justify-center bg-hacker-green text-black px-12">
             <div className="max-w-4xl">
              ...
              <h2 className="text-3xl md:text-7xl font-bold mt-4 mb-8">Total Optimization.</h2>
